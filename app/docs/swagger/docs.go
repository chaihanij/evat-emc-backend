    ...
    "paths": {
        "/health": {
            "get": {
                ...
                "summary": "HealtCheck",
                "operationId": "healt-check",
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/utils.BaseSuccessResponse"
                        }
                    },
                    "400": {
    ...
    "definitions": {
        ...
        "dtos.CreateAssignmentResponseJSON": {
            ...
            "properties": {
                ...
                "document": {
                    "$ref": "#/definitions/gitlab_com_chaihanij_evat_app_layers_deliveries_http_assignments_dtos.FileResponse"
                },
                "dueDate": {
                    "type": "string"
                },
        ...
        "dtos.CreateMemberResponseJSON": {
            ...
            "properties": {
                ...
                "documents": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/gitlab_com_chaihanij_evat_app_layers_deliveries_http_members_dtos.FileResponse"
                    }
                },
                "email": {
                    "type": "string"
        ...
        "dtos.FindAllAnnouncementResponseSwagger": {
            ...
            "properties": {
                ...
                "metaData": {
                    "$ref": "#/definitions/gitlab_com_chaihanij_evat_app_layers_deliveries_http_announcements_dtos.MetaDataResponse"
                },
                "statusCode": {
                    "type": "integer",
                    "example": 1000
        ...
        "dtos.FindAllAssignmentResponseSwagger": {
            ...
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/gitlab_com_chaihanij_evat_app_layers_deliveries_http_assignments_dtos.AssignmentResponse"
                    }
                },
                "metaData": {
                    "$ref": "#/definitions/gitlab_com_chaihanij_evat_app_layers_deliveries_http_assignments_dtos.MetaDataResponse"
                },
                "statusCode": {
                    "type": "integer",
                    "example": 1000
        ...
        "dtos.FindAllMemberResponseSwagger": {
            ...
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/gitlab_com_chaihanij_evat_app_layers_deliveries_http_members_dtos.MemberResponse"
                    }
                },
                "metaData": {
                    "$ref": "#/definitions/gitlab_com_chaihanij_evat_app_layers_deliveries_http_members_dtos.MetaDataResponse"
                },
                "statusCode": {
                    "type": "integer",
                    "example": 1000
        ...
        "dtos.FindAllTeamResponseSwagger": {
            ...
            "properties": {
                ...
                "metaData": {
                    "$ref": "#/definitions/gitlab_com_chaihanij_evat_app_layers_deliveries_http_teams_dtos.MetaDataResponse"
                },
                "statusCode": {
                    "type": "integer",
                    "example": 1000
        ...
        "dtos.FindAllUserResponseSwagger": {
            ...
            "properties": {
                ...
                "metaData": {
                    "$ref": "#/definitions/gitlab_com_chaihanij_evat_app_layers_deliveries_http_users_dtos.MetaDataResponse"
                },
                "statusCode": {
                    "type": "integer",
                    "example": 1000
        ...
        "dtos.FindOneAssignmentTeamResponseJSON": {
            ...
            "properties": {
                ...
                "documents": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/gitlab_com_chaihanij_evat_app_layers_deliveries_http_teams_dtos.FileResponse"
                    }
                },
                "isConfirmed": {
                    "type": "boolean"
        ...
        "dtos.FindOneTeamResponseJSON": {
            ...
            "properties": {
                ...
                "members": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/gitlab_com_chaihanij_evat_app_layers_deliveries_http_teams_dtos.MemberResponse"
                    }
                },
                "name": {
                    "type": "string"
        ...
        "gitlab_com_chaihanij_evat_app_layers_deliveries_http_announcements_dtos.MetaDataResponse": {
            "type": "object",
            "properties": {
                "page": {
                    "type": "integer",
        ...
        "gitlab_com_chaihanij_evat_app_layers_deliveries_http_assignments_dtos.AssignmentResponse": {
            "type": "object",
            "properties": {
                "createdAt": {
                    "type": "string"
        ...
        "gitlab_com_chaihanij_evat_app_layers_deliveries_http_assignments_dtos.FileResponse": {
            "type": "object",
            "properties": {
                "fileName": {
                    "type": "string"
        ...
        "gitlab_com_chaihanij_evat_app_layers_deliveries_http_assignments_dtos.MetaDataResponse": {
            "type": "object",
            "properties": {
                "page": {
                    "type": "integer",
        ...
        "gitlab_com_chaihanij_evat_app_layers_deliveries_http_members_dtos.FileResponse": {
            "type": "object",
            "properties": {
                "fileName": {
                    "type": "string"
        ...
        "gitlab_com_chaihanij_evat_app_layers_deliveries_http_members_dtos.MemberResponse": {
            "type": "object",
            "properties": {
                "academy": {
                    "type": "string"
        ...
        "gitlab_com_chaihanij_evat_app_layers_deliveries_http_members_dtos.MetaDataResponse": {
            "type": "object",
            "properties": {
                "page": {
                    "type": "integer",
        ...
        "gitlab_com_chaihanij_evat_app_layers_deliveries_http_teams_dtos.FileResponse": {
            "type": "object",
            "properties": {
                "fileName": {
                    "type": "string"
        ...
        "gitlab_com_chaihanij_evat_app_layers_deliveries_http_teams_dtos.MemberResponse": {
            "type": "object",
            "properties": {
                "academy": {
                    "type": "string"
        ...
        "gitlab_com_chaihanij_evat_app_layers_deliveries_http_teams_dtos.MetaDataResponse": {
            "type": "object",
            "properties": {
                "page": {
                    "type": "integer",
        ...
        "gitlab_com_chaihanij_evat_app_layers_deliveries_http_users_dtos.MetaDataResponse": {
            "type": "object",
            "properties": {
                "page": {
                    "type": "integer",
