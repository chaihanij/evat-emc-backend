...
func (r repo) getFindOptions(input *entities.FieldRaceFilter) *options.FindOptions {
...
func (r repo) FindAllFieldRace(ctx context.Context, input *entities.FieldRaceFilter) ([]entities.FieldRace, error) {
