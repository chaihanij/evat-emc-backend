...
func (r repo) AllScoreConsiderationAssignmentMember(ctx context.Context, input entities.AllScoreFilter) ([]entities.AllScore, error) {

	log.Debugln("AllScoreConsiderationAssignmentMember")
